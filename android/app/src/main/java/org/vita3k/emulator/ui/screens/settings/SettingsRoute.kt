...
fun SettingsRoute(
    ...
    fun requestStorageFolderChange() {
        ...
        activity.requestStorageFolderChange(viewModel.currentStoragePath) { path ->
        ...
        Scaffold(
            topBar = {
                TopAppBar(
                    ...
                    actions = {
                        if (!searchActive && viewModel.isDirty && !viewModel.saving) {
            ...
            if (!settingsLoaded || viewModel.loading) {
