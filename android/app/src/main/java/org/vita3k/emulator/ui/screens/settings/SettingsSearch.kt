...
internal fun rememberSettingsSearchEntries(
    ...
    return remember(context, configuration, isPerApp, isVulkan) { buildList {
        add(entry(SettingsCategory.Core, R.string.settings_modules_mode, R.string.settings_modules_automatic_desc))
        add(entry(SettingsCategory.Core, R.string.settings_modules_list_title, R.string.settings_modules_list_desc, keywords = "lle modules firmware"))
        ...
        if (!isPerApp) {
            ...
            add(entry(SettingsCategory.Emulator, R.string.settings_emulator_ui_language, R.string.settings_emulator_ui_language_desc, scope = SettingsScope.Global, keywords = "interface ui app language locale"))
            add(entry(SettingsCategory.Emulator, R.string.settings_emulator_show_live_area, R.string.settings_emulator_show_live_area_desc, scope = SettingsScope.Global))
            ...
            add(entry(SettingsCategory.Emulator, R.string.settings_emulator_log_level, scope = SettingsScope.Global, keywords = "logging trace debug info warning error critical off"))
            ...
            add(entry(SettingsCategory.Emulator, R.string.settings_emulator_perf_overlay_detail, scope = SettingsScope.Global, keywords = "minimum low medium maximum"))
            add(entry(SettingsCategory.Emulator, R.string.settings_emulator_perf_overlay_position, scope = SettingsScope.Global, keywords = "top bottom left center right"))
            add(entry(SettingsCategory.Emulator, R.string.settings_emulator_screenshot_format, scope = SettingsScope.Global, keywords = "jpeg png none"))
        }
    } }
}
