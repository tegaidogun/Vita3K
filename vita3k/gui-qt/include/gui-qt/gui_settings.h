...
const QString DefaultStylesheet = QStringLiteral("default");
const QString DarkStylesheet = QStringLiteral("dark");
const QString NoStylesheet = QStringLiteral("none");
const QString NativeStylesheet = QStringLiteral("native");
...
const GuiSave m_currentStylesheet = GuiSave(meta, QStringLiteral("currentStylesheet"), QStringLiteral("native (Fusion)"));
