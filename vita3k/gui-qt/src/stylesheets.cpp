...
const QString default_style_sheet(
    ...
    "QComboBox { background-color: #ffffff; color: #202020; border: 1px solid #b8b8b8; border-radius: 2px; padding: 2px 6px; }"
    ...
    "QSpinBox, QDoubleSpinBox { background-color: #ffffff; color: #202020; border: 1px solid #b8b8b8; border-radius: 2px; padding: 2px; selection-background-color: #148aff; selection-color: #ffffff; }"
...
const QString dark_style_sheet(
    ...
    "QToolButton#welcome_firmware_button:pressed { background-color: #2a82da; }"
    ...
    "QToolButton#welcome_firmware_button::menu-button:pressed { background: #2a82da; }"
    ...
    "QSpinBox, QDoubleSpinBox { background-color: #2a2a2a; color: #e0e0e0; border: 1px solid #555555; border-radius: 2px; padding: 2px; selection-background-color: #2a82da; selection-color: #ffffff; }"
